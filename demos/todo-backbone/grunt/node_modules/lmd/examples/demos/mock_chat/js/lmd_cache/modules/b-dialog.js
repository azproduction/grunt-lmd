...
Dialog.prototype.renderWrapper = function () {
    return '<div class="b-dialog js-dialog">' +
                '<div class="b-dialog__header">' +
                    '<div class="b-dialog__header__photo js-photo"></div>' +
                    '<div class="b-dialog__header__name">' + this.renderName('Test Test Test Test') + '</div>' +
                    '<div class="b-dialog__header__buttons">' +
                        '<div class="b-dialog__header__buttons__close js-close">X</div>' +
                    '</div>' +
                '</div>' +
                '<div class="b-dialog__talk js-talk"></div>' +
                '<div class="b-dialog__message-area">' +
                    '<textarea class="b-dialog__message-area__textarea js-text"></textarea>' +
                '</div>' +
                '<div class="b-dialog__icon-panel">' +
                    '<div class="b-dialog__icon-panel__icon"></div>' +
                    '<div class="b-dialog__icon-panel__icon"></div>' +
                    '<div class="b-dialog__icon-panel__icon"></div>' +
                    '<div class="b-dialog__icon-panel__icon"></div>' +
                    '<div class="b-dialog__icon-panel__icon"></div>' +
