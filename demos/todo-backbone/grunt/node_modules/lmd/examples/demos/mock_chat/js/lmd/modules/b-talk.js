...
function Talk(element) {
    ...
    this.talkElement = $('.b-talk', element);
}
...
Talk.prototype.addItem = function (who, text) {
    var html;
    if (who === 'You') {
        html = '<div class="b-talk__item">' +
                    '<span class="b-talk__item__name b-talk__item__name_self_yes">' + this.renderName(who) + '</span>' +
                    '<span class="b-talk__item__message">' + this.renderText(text) + '</span>' +
                '</div>';
    } else {
        html = '<div class="b-talk__item">' +
                    '<span class="b-talk__item__name">' + this.renderName(who) + '</span>' +
                    '<span class="b-talk__item__message">' + this.renderText(text) + '</span>' +
                '</div>';
    }
